...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 22, 0, 509);
    		},
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 20, 4, 567);
    			attr_dev(div, "class", "h-full grid place-content-center");
    			add_location(div, file, 19, 3, 516);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div1 = element("div");
    			div1.textContent = "This is the search area.";
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "This is the results area.";
    			script0.defer = true;
    			script0.async = true;
    			...
    			add_location(script0, file, 6, 1, 98);
    			script1.defer = true;
    			...
    			add_location(script1, file, 9, 1, 240);
    			attr_dev(div0, "class", "h-1/3 lg:h-full");
    			add_location(div0, file, 15, 1, 448);
    			add_location(div1, file, 25, 2, 666);
    			add_location(div2, file, 26, 2, 704);
    			attr_dev(div3, "class", "");
    			add_location(div3, file, 24, 1, 649);
    			attr_dev(div4, "class", "w-full h-screen lg:grid lg:grid-cols-2");
    			add_location(div4, file, 14, 0, 394);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Map: Map$1, ready });
