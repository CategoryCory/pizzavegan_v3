    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 21, 4, 644);
    			attr_dev(div, "class", "h-full grid place-content-center");
    			add_location(div, file, 20, 3, 592);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h2);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			div1 = element("div");
    			div1.textContent = "This is the results area.";
    			script0.defer = true;
    			script0.async = true;
    			...
    			add_location(div0, file, 16, 1, 520);
    			add_location(div1, file, 27, 2, 765);
    			attr_dev(div2, "class", "");
    			add_location(div2, file, 25, 1, 730);
    			attr_dev(div3, "class", "w-full h-screen lg:grid lg:grid-cols-2");
    			add_location(div3, file, 15, 0, 465);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
